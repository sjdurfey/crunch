...
public class HCatSourceITest extends CrunchTestSupport {
  ...
  @Test
  public void test_HCatToSpecificRecord_FromHCatAsAvro() throws IOException, HiveException, TException, SerDeException {
    String tableName = testName.getMethodName();
    Path tableRootLocation = temporaryPath.getPath(tableName);
    ...
    Iterable<Player> materialized = FromHCat.tableAsAvro(pipeline, tableName, Player.class).materialize();
  ...
  public void test_HCatToSpecificRecord_FromHCatAsAvro_OverrideFactory()
    ...
    testConf.set(HCatSourceTarget.DATUM_READER_WRITER_FACTORY_PROP,
